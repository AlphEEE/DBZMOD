...
namespace DBZMOD.Projectiles
{
    public class GalickGunBlast : KiProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y - 0, 0, 0, mod.ProjectileType("GalickGunTrail"), projectile.damage, 4f, projectile.owner, 0, projectile.rotation);
                projectile.ai[1] = 0;
            }
        }
