...
namespace DBZMOD.Projectiles
{
	public class DoubleSundayBlast : KiProjectile
	{
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y - 0, 0, 0, mod.ProjectileType("DoubleSundayTrail"), projectile.damage, 4f, projectile.owner, 0, projectile.rotation);
                projectile.ai[1] = 0;
            }
        }
	}
